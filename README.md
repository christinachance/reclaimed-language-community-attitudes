# IYKYK (But AI Doesn't): Automated Content Moderation Does Not Capture Communities' Heterogeneous Attitudes Towards Reclaimed Language [![Paper](https://img.shields.io/badge/paper-read-blue)]([https://github.com/christinachance/reclaimed-language-community-attitudes/](https://arxiv.org/abs/2604.16654))

## Overview

This repository contains the code for figure and table generation accompanying the paper **"IYKYK (But AI Doesn't): Automated Content Moderation Does Not Capture Communities' Heterogeneous Attitudes Towards Reclaimed Language"**.

---

## Data Availability

The dataset is **not publicly available** due to the sensitive nature of its content.

If you are interested in accessing the data for research purposes, please reach out to:
